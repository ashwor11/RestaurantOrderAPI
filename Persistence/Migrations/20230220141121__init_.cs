        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Campaigns_Menus_MenuId",
                        column: x => x.MenuId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CampaignDrinks", x => new { x.CampaignId, x.DrinkId });
                    table.ForeignKey(
                        name: "FK_CampaignDrinks_Campaigns_CampaignId",
                        column: x => x.CampaignId,
                        principalTable: "Campaigns",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CampaignDrinks_Drinks_DrinkId",
                        column: x => x.DrinkId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CampaignFoods", x => new { x.CampaignId, x.FoodId });
                    table.ForeignKey(
                        name: "FK_CampaignFoods_Campaigns_CampaignId",
                        column: x => x.CampaignId,
                        principalTable: "Campaigns",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CampaignFoods_Foods_FoodId",
                        column: x => x.FoodId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CampaignDrinks_DrinkId",
                table: "CampaignDrinks",
                column: "DrinkId");

            migrationBuilder.CreateIndex(
                name: "IX_CampaignFoods_FoodId",
                table: "CampaignFoods",
                column: "FoodId");

            migrationBuilder.CreateIndex(
                name: "IX_Campaigns_MenuId",
                table: "Campaigns",
                column: "MenuId");
